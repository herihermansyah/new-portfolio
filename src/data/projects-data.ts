export const projectsData = [
  ...
  },
  {
   ...
   {
    id: 16,
    name: "Business Landing Page Exploration",
    live: "https://bussiness-landing-page-exploration.vercel.app/",
    github: "https://github.com/herihermansyah/bussiness-landing-page-exploration",
    thumbnail: "/bussiness-005.png",
    about: "A modern, high-performance, and fully responsive business landing page built to showcase corporate services, client testimonials, and interactive sections with smooth user experiences.",
         tech: [
      {name: "NextJs"},
      {name: "tailwindCss"},
      {name: "typescript"},
   ...
   {
    id: 17,
    name: "Dafixel Marketing Agency Website",
    live: "https://dafixel-marketing-agency-website.vercel.app/",
    github: "https://github.com/herihermansyah/dafixel-marketing-agency-website",
    thumbnail: "/marketing-005.webp",
    about: "A modern, high-performance, and fully responsive marketing agency website designed to deliver an exceptional user experience with smooth animations and clean design aesthetics.",     tech: [
      {name: "NextJs"},
      {name: "tailwindCss"},
      {name: "typescript"},
      {name: "tailwind-merge"},
