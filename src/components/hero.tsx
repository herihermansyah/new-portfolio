...
const Hero = () => {
  return (
    <WrapperMotion className="py-20 bg-Light-Yellow-Cream shadow-dropdown-Pale-Mint">
        ...
        <div className="flex flex-col items-start gap-5 lg:w-200">
          ...
          <ChildMotion>
            <p className="text-Dark-Maroon/70">
              ...
              architecture and optimizing loading speeds to deliver seamless
              user experiences that actually drive results.
            </p>
          </ChildMotion>
          <a
            href="/cv.pdf"
